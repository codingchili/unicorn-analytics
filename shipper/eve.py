...
parser = argparse.ArgumentParser(description=green('Eve events shipper.'))
parser.add_argument('--server', help=f"target server, {yellow('ws://')} or {yellow('http://')}.", metavar='URL')
